...
const Problems = () => {
  ...
  return (
    <div className="w-full text-black md:p-8">
      <h1 className="font-bold font-whalebold text-3xl mb-6">{t("FAQ")}</h1>
      <Divider />
      ...
      <div className="mt-10">
        <details className="collapse collapse-arrow bg-white text-black">
          ...
          <div className="collapse-content text-sm text-threePranentTransblack">
            <h2 className="text-black text-base font-bold my-2">{t("In terms of technical execution, CycleX combines the automated execution at the online contract level with the offline real asset circulation. The specific implementation process is as follows")}:</h2>
        ...
        <details className="collapse collapse-arrow bg-white text-black">
          ...
          <div className="collapse-content text-sm text-threePranentTransblack">
            <h2 className="text-black text-base font-bold my-2">{t("CycleX has made the following preparations in terms of regulatory compliance")}:</h2>
        ...
        <details className="collapse collapse-arrow bg-white text-black">
          ...
          <div className="collapse-content text-sm text-threePranentTransblack">
            <h2 className="text-black text-base font-bold my-2">{t("CycleX has taken strict security measures to ensure the authenticity of offline assets and the flow of online assets")}:</h2>
        ...
        <details className="collapse collapse-arrow bg-white text-black">
          ...
          <div className="collapse-content text-sm text-threePranentTransblack">
            <h2 className="text-black text-base font-bold my-2">{t("Regulatory authority approval")}:</h2>
        ...
        <details className="collapse collapse-arrow bg-white text-black">
          ...
          <div className="collapse-content text-sm text-threePranentTransblack">
            <h2 className="text-black text-base font-bold my-2">{t("The current composition and structure of CycleX's main products are as follows")}:</h2>
