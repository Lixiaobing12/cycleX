            ...
            <li>
              <details className="collapse collapse-arrow bg-white text-black">
                ...
                <div className="collapse-content text-sm text-black-800">
                  <ol className="ml-2">
                    <li>
                      The CycleX platform, as an innovative real-world asset tokenization (RWA) platform, is defining a new future of asset management and investment. By converting real-world assets
                      into digital tokens, the platform not only increases the liquidity and accessibility of these assets, but also provides investors with unprecedented opportunities. Our definition
                      of RWA is intentionally broader than traditional financial assets and includes assets such as creator royalties, commodities, physical goods, in addition to traditional assets
                      such as trade finance, structured credit, Treasury bills, real estate, creator royalties, etc. Our mission is to bring traditional and new-age assets into the global on-chain
                      ecosystem. We introduce the Token Fund model, which is a type of token backed by an underlying asset class backed by real assets that will mature within an agreed period.
                    </li>
                  </ol>
                </div>
              </details>
            ...
            <li>
              <details className="collapse collapse-arrow bg-white text-black">
                ...
                <div className="collapse-content text-sm text-black-800">
                  <ol className="ml-2">
                    <li>
                      2.1 Product Diversity: Cycle X is committed to the realization of a wide range of assets tokenization, covering accounts receivable, REITS, bills and other products. This rich
                      and diverse selection of assets enables investors to diversify their risk and optimize their portfolios.
                    </li>
                    <li>
                    ...
                    <li>
                      2.4 Sense of Use: The platform provides intuitive user interface and comprehensive customer service to simplify the tokenization and investment process and ensure convenient and
                      efficient user experience.
                    </li>
                    <li>
                      2.5 Liquidity: CycleX has significantly enhanced asset liquidity and investment attractiveness by subdividing large value assets into smaller token units, opening the investment
                      door to a wide group of investors.
                    </li>
                    <li>
                      2.6 Security: Using the most advanced encryption and blockchain technology, CycleX ensures high security and immutability of transactions, providing investors with confidence.
                    </li>
                  </ol>
                </div>
              </details>
              ...
              <details className="collapse collapse-arrow bg-white text-black">
                ...
                <div className="collapse-content text-sm text-black-800">
                  <p>
                    ...
                    circulate, not only enhancing asset value, but also opening up a broader capital market for asset holders. The platform product portfolio is diversified, the use of convenience and
                    smoothness, and the secondary market is opened up to increase market liquidity.
                  </p>
                </div>
              </details>
            </li>
              ...
              <details className="collapse collapse-arrow bg-white text-black">
                ...
                <div className="collapse-content text-sm text-black-800">
                  <p>
                    ...
                    Token Fund is developed according to the ERC 1400 standard and is equipped with the latest security features and is certified by BlockSec and Zellic.io. Investors can both mint and
                    redeem the Token Fund through CycleX, which is specifically created for qualified investors seeking a stable rate of return and is only transferable to account holders pre-approved
                    through the KYC/AML whiterist mechanism.
                  </p>
                </div>
              </details>
            </li>
              ...
              <details className="collapse collapse-arrow bg-white text-black">
                ...
                <div className="collapse-content text-sm text-black-800">
                  <ol className="ml-2">
                    ...
                    <li>
                      5.2 Redemption Token Fund redemption can be applied for through the APP. Token exchange enables verified qualified investors to exchange token funds for USDT. This process can
                      only be performed by whitelist addresses. The final settlement amount is calculated as the Token Fund redemption amount * handling fee.
                    </li>
                    <li>
                      5.3 Secondary market liquidity of the Token Fund The purpose of establishing the secondary market for Token funds is to provide secondary market liquidity and increase returns
                      for Token Fund holders. Through the secondary trading market, users can redeem and purchase products. The secondary market plans to trade through other Stablecoins in the future,
                      such as USDC and DAI. By providing liquidity, verified qualified investors can offer single or multiple stable coins to generate gains from the secondary market.
                    </li>
                  </ol>
                </div>
              </details>
                  ...
                  <ol className="ml-2">
                    <li>
                      ...
                      <ol className="ml-2">
                        ...
                        <li>
                          6.1.2 Distribution of benefits During the duration of the project, users can enjoy the benefits brought by the project. Users return tokens to Cycle X to recover funds (plus
                          accrued earnings) When these underlying assets earn earnings, that earnings are reinvested into purchasing more assets, automatically compounding the user's earnings.
                        </li>
                        <li>
                          6.1.3 Redemption of tokens Users sell their tokens in the secondary market. After the project period ends, the project's tokens are destroyed on the chain. At the specified
                          time, the user will receive the token in the account. The user is then free to transfer the tokens to their wallet account. At any time, if the user wants to redeem the
                          token, the user token will be burned and the user will then receive the USDC.
                        </li>
                      </ol>
                    </li>
                    <li>
                      ...
                      <p className="my-2">In particular, the Token Fund token contract implements the ERC1594 transmission limit specification and the ERC1644 controller operation specification</p>
                      <ol className="ml-2">
                        <li>
                        ...
                        <li>
                          ...
                          <p className="my-2">
                            ...
                            functionality as the controller contract for all three roles. All Token Fund administrator activities are executed through this controller contract, and each action goes
                            through two phases of proposal and execution, and the execution must conform to the delay specified by the time lock.
                          </p>
                          ...
                          <p>
                            ...
                            operation cannot be ensured because it requires a 4-hour delay, while the "burn" operation can only be delayed for 60 hours. Avoid passing delay parameters from the caller
                            to prevent security issues due to compromised business systems.
                          </p>
                          <p className="my-2">
                            Add custom logic to the controller smart contract implementation to set different "delay" values (parsed according to the first four bytes of calldata) for various actions.
                          </p>
                          <p className="my-2">
                            In order to modify the "delay" value in the future, redeploy a new controller smart contract and set the administrator role of the Token Fund to the new controller through
                            the old controller.
                          </p>
                        </li>
                      </ol>
                    ...
                    <li>
                      ...
                      <p className="my-2">
                        When deployed, the owner of the agent contract is set as a time-limited lock contract, and the subsequent upgrade of the Token Fund contract is limited when the lock contract
                        control. Token Fund contract
                      </p>
                      ...
                      <ol className="ml-2">
                        <li>
                          ...
                          <p className="my-2">
                            Proposer/Executor/Canceller are three different EOA addresses, where proposer and Executor are Cactus escrow addresses. Any management operation on the contract needs to be
                            initiated by the proposer through the timelock contract. After the timelock expires, the executor will invoke and execute the operation, and both the proposer and the
                            executor will sign the operation. A Canceler is a self-hosted hardware wallet (or two) that can call a timelock controller to cancel an operation that has been scheduled
                            during timelock. For now, to balance security and operational efficiency, we set timelock cycles for Mint, Burn, and Rebase to a fixed time.
                          </p>
                        </li>
                        <li>
                          6.3.2 Redemption
                          ...
                          <p className="my-2">
                            To redeem, the user first needs to approve the corresponding number of tokens to the contract's administrator, and then the administrator initiates the 'redeemFrom' method
                            call to the smart contract. If the user's address belongs to a CycleX account, the system will automatically help the user to call the 'approve' method. Otherwise, the user
                            needs to actively call the "approve" method to authorize a certain number of tokens to the smart contract's administrator, which is the timelock controller.
                          </p>
                          <p className="my-2">
                            The administrator of the contract initiates this method call to the smart contract in order to redeem the tokens belonging to the administrator. User tokens can be burned
                            without the user's permission, which conflicts with the decentralized nature of blockchains
                          </p>
                          <p className="my-2">
                    ...
                    <li>
                      ...
                      <ol className="ml-2">
                        <li>
                          ...
                          <p className="my-2">
                            This is mainly applicable to scenarios where the Token Fund contract logic needs to be modified. The specific actions include redeploying the Token Fund smart contract and
                            calling the "resetimimplementation" method of the proxy contract through the time lock controller to specify the new implementation of the Token Fund contract.
                          </p>
                        </li>
                        <li>
                          6.4.2 Upgrade the timelock controller
                          <p className="my-2">
                            This mainly addresses scenarios where the timelock duration length needs to be updated. The specific actions include redeploying the Timelock controller smart contract and
                            updating the proxy contract owner and the Token Fund controller/issuer/mediator to the new timelock by calling the "old Timelock contract".
                          </p>
                          <p className="my-2">
                            This will result in subsequent Token Fund contract calls being directed to the new timelock controller. It is important to note that all existing operations for the "old
                            timelock contract" must already have been executed.
                          </p>
                        </li>
                        <li>
                  ...
                  <ol className="ml-2">
                    <li>
                      ...
                      <ol className="ml-2">
                        ...
                        <li>
                          9.1.2 In-depth User experience optimization: Based on the collected user feedback, in-depth interface and transaction process optimization will be carried out to improve user
                          satisfaction and platform ease of use.
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ol className="ml-2">
                        ...
                        <li>
                          9.2.2 Comprehensive upgrade of platform functions: Advanced functions based on the latest market trends and user needs are introduced to improve transaction efficiency and
                          security.
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ol className="ml-2">
                        ...
                        <li>
                          9.3.2 Enhanced Global Compliance: Continuously monitor legal and regulatory changes in global financial markets to ensure that platform operations are always in compliance
                          with international compliance standards. Obtain relevant business qualifications in accordance with the requirements of the countries in which the platform operates.
                        </li>
                        <li>
              ...
              <details className="collapse collapse-arrow bg-white text-black">
                ...
                <div className="collapse-content text-sm text-black-800">
                  <ol className="ml-2">
                    ...
                    <li>
                      10.3 Asset Rating All products are subject to off-chain due diligence and enhanced security through guaranteed credit enhancement measures. And have a professional team to rate
                      the assets.
                    </li>
            ...
            <li>
              <details className="collapse collapse-arrow bg-white text-black">
                ...
                <div className="collapse-content text-sm text-black-800">
                  ...
                  <p className="my-2">
                    Cycle X is committed to the effective operation of real assets through blockchain to maximize the value of assets. And enable global investors to enjoy the benefits of investment
                    convenience. The purpose of the platform is to use technology to break down physical boundaries and improve the best match rate between funds and assets.
                  </p>
                </div>
              </details>
            </li>
